package com.radlly.configuration.redis;
 ...
 */
//@Configuration
public class RedisConfigBak extends CachingConfigurerSupport implements EnvironmentAware {

    private final Logger logger = Logger.getLogger(RedisConfigBak.class);
