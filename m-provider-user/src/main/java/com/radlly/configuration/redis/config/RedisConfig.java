package com.radlly.configuration.redis.config;
...
import com.radlly.configuration.redis.cache.CustomizedRedisCacheManager;
import com.radlly.configuration.redis.serializer.FastJsonRedisSerializer;
import com.radlly.configuration.redis.serializer.StringRedisSerializer;
...
//        jackson2JsonRedisSerializer.setObjectMapper(om);
        ...
        // 建议使用这种方式，小范围指定白名单
        ParserConfig.getGlobalInstance().addAccept("com.radlly.");
